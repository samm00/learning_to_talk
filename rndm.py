...
for i in range(5):
   # print(assign_numbers(intermix('aae')))
   assign_numbers(intermix('aae')).to_csv('/home/sam/Documents/ME_Study/randomized_stimuli/randomized_stimuli_AAE' + str(i) + '.csv', index = False) # Export to csv
   assign_numbers(intermix('gae')).to_csv('/home/sam/Documents/ME_Study/randomized_stimuli/randomized_stimuli_GAE' + str(i) + '.csv', index = False)